...
import { ArrowLeft, Save, Eye, Shield, History as HistoryIcon, CheckCircle2, Sparkles } from "lucide-react";
...
export function EditorHeader({ courseId, course, showSaveIndicator, onSave, onPreview }: EditorHeaderProps) {
  return (
    <header
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p
            className="truncate text-xs font-bold leading-none tracking-tight text-[var(--gray-900)] sm:text-[13px] lg:max-w-[400px]"
            style={{ fontFamily: FONT, marginBottom: 3 }}
          >
            {course.title}
          </p>
          <div
          ...
          >
            ...
            <span style={{ fontWeight: 700, color: "var(--gray-500)" }}>{course.version}</span>
            <span style={{ color: "var(--border-md)" }}>·</span>
            <span
              style={{
