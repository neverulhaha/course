...
/* ─── Mock recent courses (would come from state/context) ─── */

const RECENT = [
  { id: "1", title: "Основы Python для начинающих"   },
  { id: "2", title: "Введение в Machine Learning"     },
];
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span
              style={{
                fontFamily: FONT, fontWeight: 800,
                fontSize: "13px", color: "var(--gray-900)",
              }}
            >
              Версиум
            </span>
