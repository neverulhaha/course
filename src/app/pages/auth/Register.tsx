...
export default function Register() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-10 text-slate-950"><section className="mx-auto w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="mb-6 space-y-2"><p className="text-sm font-semibold text-blue-600">Версиум</p><h1 className="text-2xl font-bold tracking-tight">Создание аккаунта</h1><p className="text-sm text-slate-500">Регистрация работает без SMTP и подтверждения почты.</p></div>
