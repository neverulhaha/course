...
function EditorMock() {
  const lessons = [
    { title: "Что такое программирование?", status: "#2ECC71", qa: 92 },
    { title: "Установка и первая программа", status: "#4A90E2", qa: 88, active: true },
    { title: "Переменные и типы данных",     status: "#F1C40F", qa: 75 },
  ];
      ...
      <div className="flex" style={{ height: "320px" }}>
        ...
        >
          ...
          <div className="mt-auto flex items-center justify-center">
            ...
            >
              <span style={{ fontSize: "18px", fontWeight: 700, color: "#4A90E2", lineHeight: 1 }}>87</span>
...
/** Упрощённый мок редактора для узких экранов — без горизонтального скролла */
function EditorMockCompact() {
  return (
    <div
    ...
    >
      ...
      <div className="p-4 space-y-3">
        <div className="rounded-lg h-3 max-w-[85%]" style={{ width: "80%", background: "rgba(255,255,255,0.14)" }} />
        <div className="rounded-lg h-2 max-w-[60%]" style={{ width: "55%", background: "rgba(255,255,255,0.08)" }} />
        {[
          { accent: "#4A90E2", lines: 2 as const },
          { accent: "#4A90E2", lines: 2 as const },
          { accent: "#2ECC71", lines: 1 as const, code: true },
        ].map((b, i) => (
          <div
            key={i}
            className="rounded-lg overflow-hidden"
            style={{ border: "1px solid rgba(255,255,255,0.07)", borderLeft: `3px solid ${b.accent}` }}
          >
            <div className="h-2 mx-3 my-2 rounded" style={{ width: "40%", background: "rgba(255,255,255,0.12)" }} />
            <div className="px-3 pb-2.5 space-y-1.5" style={{ background: b.code ? "rgba(0,0,0,0.25)" : "transparent" }}>
              {Array.from({ length: b.lines }).map((_, li) => (
                <div
                  key={li}
                  className="rounded h-1.5"
                  style={{
                    width: li === b.lines - 1 ? "70%" : "100%",
                    background: b.code ? "rgba(46,204,113,0.25)" : "rgba(255,255,255,0.1)",
                  }}
                />
              ))}
            </div>
        ...
        <div className="flex items-center justify-between pt-1">
          <div className="rounded h-2 flex-1 mr-3" style={{ background: "rgba(255,255,255,0.06)" }} />
          <div
            className="shrink-0 rounded-lg px-2 py-1 font-bold tabular-nums"
            style={{ fontSize: "11px", color: "#4A90E2", border: "1px solid rgba(74,144,226,0.25)" }}
          >
            QA 87
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-16 items-center">
            ...
            <div className="min-w-0 text-center lg:text-left order-1">
              ...
              >
                ...
                и полное версионирование каждого изменения.
              </p>
      ...
      >
        <div className="w-full max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-4 sm:gap-x-8 lg:gap-12 justify-items-center">
            {[
              { value: "87",   label: "Средний QA-балл курса",   accent: "var(--brand-blue)" },
              { value: "100%", label: "Проверка источников",      accent: "#2ECC71" },
              { value: "6",    label: "Критериев качества",       accent: "#F1C40F" },
              { value: "∞",    label: "Версий с откатом",         accent: "var(--brand-blue)" },
          ...
          <div className="grid md:grid-cols-2 gap-x-8 lg:gap-x-16 xl:gap-x-24 gap-y-0 max-w-4xl mx-auto md:max-w-none">
            ...
            <div>
              ...
              <Step
                ...
                desc="Готовый курс доступен в режиме обучения. История версий сохраняет каждое изменение."
              />
            </div>
          </div>
        </div>
        ...
        <div className={SHELL}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
            ...
            <FeatureCard
              icon={History}
              title="Версионность"
              desc="Полная история изменений курса. Сравнение версий и откат к любому предыдущему состоянию."
            />
            <FeatureCard
              icon={BookOpen}
            ...
            <div className="min-w-0 order-2 md:order-1 text-center md:text-left">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {[
                  ...
                  { icon: RefreshCw, text: "Автосохранение и версионирование" },
                ].map(({ icon: Icon, text }) => (
        ...
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span
              ...
              style={{ fontSize: "var(--text-sm)", color: "rgba(255,255,255,0.6)" }}
            >
              Версиум
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 sm:justify-center">
            {[
              ...
              { label: "Войти", href: "/auth", external: false },
